    ...
    >
      ...
      >
        ...
        <div>
          <p className="font-semibold  ">
            <span className="decoration-indigo-500 group-hover:underline">
              {post.author.name}
            </span>{" "}
            &#x2022;{" "}
            <span className="mx-1">
      ...
      >
        ...
        <div className="col-span-4">
          <div className="h-full w-full transform rounded-xl bg-gray-300 transition duration-300 hover:scale-105 hover:shadow-md">
            {post.featuredImage && (
              <Image
